...
pattern_set(global.Base_Pattern_Color, elevatoractor, peppino_index, 1, 1, global.palettetexture)
pal_swap_set(obj_player1.spr_palette, obj_player1.paletteselect, 0)
draw_sprite(elevatoractor, peppino_index, peppino_x, peppino_y)
pattern_reset()
shader_reset()
for (var i = 0; i < 10; i++)
