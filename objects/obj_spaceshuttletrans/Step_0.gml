    ...
    with (obj_player)
    {
        if check_player_coop()
        {
            ...
            if (room == space_1)
            {
                ...
                repeat (5)
                    create_debris((x + random_range(-20, 20)), (y + 40), 3336)
            }
            if (room == space_5)
            {
                repeat (5)
                    create_debris((x + random_range(-20, 20)), (y + 40), 3579)
            }
            if (room == space_9)
            {
                repeat (5)
                    instance_create((x + random_range(-50, 50)), (y + random_range(-50, obj_negativenumber)), obj_olivebubbledeco)
                repeat (5)
                    create_debris((x + random_range(-20, 20)), (y + 40), 3821)
            }
