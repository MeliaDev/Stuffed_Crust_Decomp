with (obj_player)
{
    if (state == (84 << 0) && (sprite_index == spr_supertaunt1 || sprite_index == spr_supertaunt2 || sprite_index == spr_supertaunt3 || sprite_index == spr_supertaunt4 || sprite_index == spr_supertaunt5))
...
if (kidsparty_lightning || dark_lightning)
{
    ...
    if (!surface_exists(patrolcone_tex))
    {
        ...
        draw_triangle_color(0, (tsh / 2), p[0], p[1], p[2], p[3], c_white, c_white, c_white, 0)
    ...
    if kidsparty_lightning
    {
        if surface_exists(surf)
        {
            ...
            with (obj_patrolcone)
            {
                if (instance_exists(baddieID) && baddieID.state == (134 << 0))
                {
