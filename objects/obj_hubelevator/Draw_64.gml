if (state == (18 << 0))
{
    ...
    draw_rectangle_color(((obj_screensizer.actual_width / 2) - (w / 2)), ((obj_screensizer.actual_height / 2) - (h / 2)), ((obj_screensizer.actual_width / 2) + (w / 2)), yy, c_black, c_black, c_black, c_black, 0)
    yy -= (pad / 2)
