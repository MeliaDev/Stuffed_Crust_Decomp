event_inherited()
active = 1
function anon_gml_Object_obj_soundtest_next_Create_0_45_gml_Object_obj_soundtest_next_Create_0() //anon_gml_Object_obj_soundtest_next_Create_0_45_gml_Object_obj_soundtest_next_Create_0
{
    with (obj_soundtest)
    {
        other.active = 0
