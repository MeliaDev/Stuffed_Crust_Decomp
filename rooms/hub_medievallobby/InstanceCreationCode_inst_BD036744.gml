...
function anon_gml_RoomCC_hub_medievallobby_8_Create_970_gml_RoomCC_hub_medievallobby_8_Create() //anon_gml_RoomCC_hub_medievallobby_8_Create_970_gml_RoomCC_hub_medievallobby_8_Create
{
    var no_money = 0
    if no_money
