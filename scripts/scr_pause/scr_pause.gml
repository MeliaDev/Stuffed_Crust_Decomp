function scr_pauseicon_draw(argument0, argument1, argument2) //scr_pauseicon_draw
{
...
function scr_pause_stop_sounds() //scr_pause_stop_sounds
{
...
function scr_pauseicon_add(argument0, argument1, argument2, argument3) //scr_pauseicon_add
{
...
function scr_pauseicons_update(argument0) //scr_pauseicons_update
{
...
function scr_pause_activate_objects(argument0) //scr_pause_activate_objects
{
...
function scr_pause_deactivate_objects(argument0) //scr_pause_deactivate_objects
{
    if (argument0 == undefined)
        argument0 = 1
    if argument0
...
function pause_spawn_priests() //pause_spawn_priests
{
    var p = 
    {
        x: 0,
        ...
        image_alpha: 0,
        sprite_index: choose(3426, 1507, 2905)
    }
...
function pause_unpause_music() //pause_unpause_music
{
    with (obj_music)
    {
        if (music != noone)
...
function pause_update_priests() //pause_update_priests
{
...
function pause_draw_priests() //pause_draw_priests
{
    for (i = 0; i < ds_list_size(priest_list); i++)
    {
