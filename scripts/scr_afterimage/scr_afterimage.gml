function create_afterimage(argument0, argument1, argument2, argument3) //create_afterimage
{
    var q = 
    {
        ...
        image_angle: 0,
        alarm: [15, 6, -1],
        image_blend: choose(global.afterimage_color1, global.afterimage_color2, global.afterimage_color3),
        image_xscale: 1,
        image_yscale: 1,
        identifier: (0 << 0),
        visible: true,
...
function create_mach3effect(argument0, argument1, argument2, argument3, argument4) //create_mach3effect
{
    ...
    q = 
    {
        ...
        image_angle: 0,
        alarm: [15, 6, -1],
        image_blend: choose(global.mach_color1, global.mach_color2, global.mach_color3),
        image_xscale: 1,
        image_yscale: 1,
        visible: true,
        identifier: (1 << 0),
