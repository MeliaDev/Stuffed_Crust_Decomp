function scr_pizzaface_init_sounds() //scr_pizzaface_init_sounds
{
...
function scr_pizzaface_destroy_sounds() //scr_pizzaface_destroy_sounds
{
    destroy_sounds([snd_ram, snd_spit, snd_haywire, snd_wind])
}

function scr_pizzaface_update_sounds() //scr_pizzaface_update_sounds
{
...
function scr_pizzaface_arenaintro() //scr_pizzaface_arenaintro
{
    if (!skipintro)
    {
        image_speed = 0.35
...
function scr_pizzaface_normal() //scr_pizzaface_normal
{
...
function scr_pizzaface_ram() //scr_pizzaface_ram
{
    switch substate
    {
        case (144 << 0):
...
function scr_pizzaface_transitioncutscene() //scr_pizzaface_transitioncutscene
{
    image_speed = 0.35
    image_alpha = 1
    alarm[6] = -1
