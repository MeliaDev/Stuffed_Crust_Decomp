function scr_pepperman_init_sounds() //scr_pepperman_init_sounds
{
...
function destroy_sounds(argument0) //destroy_sounds
{
...
function scr_pepperman_destroy_sounds() //scr_pepperman_destroy_sounds
{
    destroy_sounds([snd_shoulderbash, snd_groundpound])
}

function scr_pepperman_sounds() //scr_pepperman_sounds
{
    if (state == (153 << 0))
    {
...
function scr_pepperman_spawn_knight() //scr_pepperman_spawn_knight
{
    if (knightdir == -1)
    {
...
function scr_pepperman_shuffle_adds() //scr_pepperman_shuffle_adds
{
...
function scr_pepperman_arenaintro() //scr_pepperman_arenaintro
{
    if (!skipintro)
    {
        image_speed = 0.35
...
function scr_pepperman_freefallprep() //scr_pepperman_freefallprep
{
    hsp = 0
    vsp = 0
    image_speed = 0.35
...
function scr_pepperman_rolling() //scr_pepperman_rolling
{
...
function scr_pepperman_freefallland() //scr_pepperman_freefallland
{
    hsp = 0
    image_speed = 0.35
    if (landbuffer > 0)
...
function scr_pepperman_do_contemplate() //scr_pepperman_do_contemplate
{
    if (wastedhits >= 8)
    {
        b = 0
...
function scr_pepperman_contemplate() //scr_pepperman_contemplate
{
    hsp = 0
    image_speed = 0.35
}

function scr_pepperman_shoulderturn() //scr_pepperman_shoulderturn
{
...
function scr_pepperman_mini() //scr_pepperman_mini
{
    image_speed = 0.35
    if (minibuffer > 0)
        minibuffer--
...
function scr_pepperman_phase1hurt() //scr_pepperman_phase1hurt
{
    sprite_index = spr_pepperman_hurtplayer
    image_speed = 0.35
    scr_boss_phase1hurt(function() //anon_scr_pepperman_phase1hurt_gml_GlobalScript_scr_pepperman_17039_scr_pepperman_phase1hurt_gml_GlobalScript_scr_pepperman
    {
    }
)
}
