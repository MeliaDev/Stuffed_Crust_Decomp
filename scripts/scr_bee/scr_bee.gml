function scr_bee_chase() //scr_bee_chase
{
    var spd = 4
...
function scr_bee_idle() //scr_bee_idle
{
...
function scr_bee_bee() //scr_bee_bee
{
    switch substate
    {
        case (257 << 0):
...
function scr_bee_hurt() //scr_bee_hurt
{
...
function create_bee_path() //create_bee_path
{
    return 
    {
        x: obj_player1.x,
