function scr_checkanystick(argument0, argument1) //scr_checkanystick
{
...
function scr_check_menu_key(argument0) //scr_check_menu_key
{
    return (global.key_start != argument0 && global.key_slap != argument0 && global.key_taunt != argument0);
}

function scr_checkanygamepad(argument0) //scr_checkanygamepad
{
