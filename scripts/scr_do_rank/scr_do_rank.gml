    ...
    if (global.combo > 0)
    {
        ...
        else if (obj_player.character == "N" || (obj_player.character == "P" && obj_player.ispeppino == 0))
        {
            for (i = 0; i < global.comboscore; i += 10)
                create_collect((obj_player1.x + irandom_range(-60, 60)), ((obj_player1.y - 100) + irandom_range(-60, 60)), choose(2750, 2752, 2756, 2757, 2758, 2864, 2866, 2868, 2870, 2872), 10)
        }
        if (current_month == 12)
        {
            for (i = 0; i < global.comboscore; i += 10)
                create_collect((obj_player1.x + irandom_range(-60, 60)), ((obj_player1.y - 100) + irandom_range(-60, 60)), choose(2864, 2866, 2868, 2870, 2872), 10)
        }
        if (current_month == 10)
        {
            for (i = 0; i < global.comboscore; i += 10)
                create_collect((obj_player1.x + irandom_range(-60, 60)), ((obj_player1.y - 100) + irandom_range(-60, 60)), choose(2750, 2752, 2756, 2757, 2758), 10)
        }
        global.comboscore = 0
    }
