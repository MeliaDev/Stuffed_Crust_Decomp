function vigilante_start_attack(argument0, argument1) //vigilante_start_attack
{
    attack_list[argument0][argument1] = array_create(0)
}

function vigilante_add_attack(argument0, argument1, argument2, argument3) //vigilante_add_attack
{
...
function vigilante_end_attack(argument0, argument1) //vigilante_end_attack
{
    var found = 0
    var i = 0
...
function scr_vigilante_init_sounds() //scr_vigilante_init_sounds
{
...
function scr_vigilante_destroy_sounds() //scr_vigilante_destroy_sounds
{
    destroy_sounds([snd_flame, snd_mach1, snd_slide, snd_uziprep])
}

function scr_vigilante_update_sounds() //scr_vigilante_update_sounds
{
...
function scr_vigilante_arenaintro() //scr_vigilante_arenaintro
{
...
function scr_vigilante_do_hurt_phase2(argument0) //scr_vigilante_do_hurt_phase2
{
    scr_boss_do_hurt_phase2(argument0)
}

function scr_vigilante_phase1hurt() //scr_vigilante_phase1hurt
{
...
function scr_vigilante_do_cow(argument0, argument1) //scr_vigilante_do_cow
{
...
function scr_vigilante_throw_cow() //scr_vigilante_throw_cow
{
    if (shot > 0)
    {
        shot--
...
function scr_vigilante_do_revolver(argument0, argument1, argument2) //scr_vigilante_do_revolver
{
...
function scr_vigilante_do_dynamite(argument0) //scr_vigilante_do_dynamite
{
    shot = argument0
    state = (2 << 0)
...
function scr_vigilante_throw_dynamite() //scr_vigilante_throw_dynamite
{
    if (shot > 0)
    {
...
function scr_vigilante_wait() //scr_vigilante_wait
{
    hsp = Approach(hsp, 0, 1)
    if (sprite_index == spr_playerV_revolverend)
        sprite_index = spr_playerV_revolverhold
...
function scr_vigilante_estampede() //scr_vigilante_estampede
{
    hsp = 0
    image_speed = 0.35
...
function scr_vigilante_do_reload(argument0) //scr_vigilante_do_reload
{
    if (argument0 == undefined)
        argument0 = 360
    state = (269 << 0)
...
function scr_vigilante_reloading() //scr_vigilante_reloading
{
    image_speed = 0.35
    hsp = Approach(hsp, 0, 1)
    if (reloadbuffer > 0)
...
function scr_vigilante_mach2() //scr_vigilante_mach2
{
    image_speed = 0.35
...
function scr_vigilante_check_spot() //scr_vigilante_check_spot
{
...
function scr_vigilante_crouchslide() //scr_vigilante_crouchslide
{
    hsp = (image_xscale * attackspeed)
    if (attackspeed > 0)
        attackspeed -= 0.15
...
function scr_vigilante_duel() //scr_vigilante_duel
{
        ...
        switch duelphase
        {
            ...
            case 2:
                ...
                else
                {
                    ...
                    layer_background_change(bg2, 3346)
                    layer_background_change(bg1, 1853)
                    ...
                    repeat l
                    {
                        with (create_debris(((x - len) + xx), y, 1624, 1))
                        {
...
function scr_vigilante_punch() //scr_vigilante_punch
{
    image_speed = 0.35
    if (floor(image_index) == (image_number - 1))
    {
...
function scr_vigilante_flamethrower() //scr_vigilante_flamethrower
{
...
function scr_vigilante_machinegun() //scr_vigilante_machinegun
{
    if (sprite_index == spr_vigilante_uziprepare)
    {
        hsp = 0
...
function scr_vigilante_bazooka() //scr_vigilante_bazooka
{
...
function scr_vigilante_crate() //scr_vigilante_crate
{
...
function scr_vigilante_hit() //scr_vigilante_hit
{
    if (!pizzahead)
    {
