function calculate_parrallax_still_x(argument0, argument1) //calculate_parrallax_still_x
{
...
function calculate_parrallax_still_y(argument0, argument1) //calculate_parrallax_still_y
{
