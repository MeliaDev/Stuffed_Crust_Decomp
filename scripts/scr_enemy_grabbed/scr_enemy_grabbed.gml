function scr_enemy_grabbed() //scr_enemy_grabbed
{
    if (!pepperman_grab)
    {
        ...
        with (_obj_player)
        {
            if (state == (55 << 0) || state == (79 << 0) || state == (74 << 0) || state == (75 << 0) || state == (20 << 0))
            {
                if (state == (74 << 0))
                {
                    ...
                    else if (sprite_index == spr_uppunchprep)
                    {
                        other.x = x
                        other.y = (y - 14)
                    }
                    ...
                    {
                        if (sprite_index != spr_grab && sprite_index != spr_grabbing && sprite_index != spr_grabbingjump && sprite_index != spr_grabbingmove && sprite_index != spr_grabbingfall)
                            other.x = (x + (46 * xscale))
                        else
                            other.x = (x + (26 * xscale))
                        other.y = (y + 24)
            ...
            suplexhavetomash = (other.elitehit - 1)
        ...
        {
            if (elitehit > 0 && elite && _obj_player.sprite_index != _obj_player.spr_swingdingend && _obj_player.sprite_index != _obj_player.spr_swingding)
            {
                with (_obj_player)
                    state = (154 << 0)
                state = (154 << 0)
        ...
        if (_obj_player.state == (83 << 0))
        {
            ...
            if (_obj_player.sprite_index == _obj_player.spr_diagonalthrowdown)
            {
                hsp = ((-image_xscale) * 10)
                vsp = 15
            }
            if (_obj_player.sprite_index == _obj_player.spr_diagonalthrowup || _obj_player.sprite_index == _obj_player.spr_punch)
            {
                hsp = ((-image_xscale) * 10)
                vsp = -15
            }
        ...
        if (_obj_player.state == (6 << 0) && (floor(_obj_player.image_index) >= 4 || (floor(_obj_player.image_index) < 1 && _obj_player.sprite_index == _obj_player.spr_swingdingend)))
        {
            ...
            if (!important)
                global.style += (5 + (global.combo / 10))
            GamepadSetVibration((_obj_player.object_index == obj_player1 ? 0 : 1), 0.8, 0.65)
            ...
            with (_obj_player)
            {
                ...
                else if (sprite_index == spr_shoulder)
                {
                    other.hithsp = 0
                    other.hitvsp = 25
                    other.linethrown = 1
                }
                else if (sprite_index == spr_punch)
                {
        ...
        if (_obj_player.state == (76 << 0) || (_obj_player.state == (61 << 0) && (sprite_index == spr_player_piledriver || sprite_index == spr_playerN_piledriver)))
        {
