function scr_pizzaface_p3_init_attack(argument0) //scr_pizzaface_p3_init_attack
{
    attack_list[argument0] = array_create(0)
}

function scr_pizzaface_p3_add_attack(argument0, argument1, argument2) //scr_pizzaface_p3_add_attack
{
    array_push(attack_list[argument0], [argument1, argument2])
}

function scr_pizzaface_p3_init_sounds() //scr_pizzaface_p3_init_sounds
{
...
function scr_pizzaface_p3_destroy_sounds() //scr_pizzaface_p3_destroy_sounds
{
    destroy_sounds([snd_jump, snd_bigpunch, snd_swinging])
}

function scr_pizzaface_p3_update_sounds() //scr_pizzaface_p3_update_sounds
{
...
function scr_pizzaface_p3_do_player_attack(argument0) //scr_pizzaface_p3_do_player_attack
{
    with (argument0)
    {
        state = (262 << 0)
        ...
        baddieID = other.id
        image_index = 0
        randomize_animations([spr_suplexmash1, spr_suplexmash2, spr_suplexmash3, spr_suplexmash4, 737, 736, 733, spr_punch])
        punchcount = 20
    }
    hsp = 0
...
function scr_pizzaface_p3_arenaintro() //scr_pizzaface_p3_arenaintro
{
    with (obj_player1)
    {
...
function scr_pizzaface_p3_fall() //scr_pizzaface_p3_fall
{
    if (grounded && vsp > 0)
        state = (134 << 0)
}

function scr_pizzaface_p3_walk() //scr_pizzaface_p3_walk
{
...
function scr_pizzaface_p3_jump() //scr_pizzaface_p3_jump
{
    with (obj_player)
    {
...
function scr_pizzaface_p3_stomp() //scr_pizzaface_p3_stomp
{
    hsp = 0
...
function scr_pizzaface_p3_punch() //scr_pizzaface_p3_punch
{
    hsp = Approach(hsp, 0, 0.25)
...
function scr_pizzaface_p3_swinging() //scr_pizzaface_p3_swinging
{
...
function scr_pizzaface_p3_throwing() //scr_pizzaface_p3_throwing
{
    hsp = 0
...
function scr_pizzaface_p3_staggered() //scr_pizzaface_p3_staggered
{
...
function scr_pizzaface_p3_handstandjump() //scr_pizzaface_p3_handstandjump
{
...
function scr_pizzaface_p3_supergrab() //scr_pizzaface_p3_supergrab
{
    hsp = Approach(hsp, 0, 0.5)
...
function scr_pizzaface_p3_finale() //scr_pizzaface_p3_finale
{
    hsp = 0
    vsp = 0
    x = -200
