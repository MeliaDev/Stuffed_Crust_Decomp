...
System.InvalidOperationException: Stack empty.
   ...
   at UndertaleModLib.Decompiler.<DecompileFromBlock>g__FindActualNameForAnonymousCodeObject|30_2(DecompileContext context, UndertaleCode anonymousCodeObject) in D:\a\UndertaleModTool\UndertaleModTool\UndertaleModLib\Decompiler\Decompiler.cs:line 2428
*/
function scr_pizzaface_p2_init_sounds() //scr_pizzaface_p2_init_sounds
{
...
function scr_pizzaface_p2_destroy_sounds() //scr_pizzaface_p2_destroy_sounds
{
    destroy_sounds([snd_haywire, snd_tvthrow, snd_spin, snd_grablevel, snd_fishing, snd_ratball])
}

function scr_pizzaface_p2_update_sounds() //scr_pizzaface_p2_update_sounds
{
    ...
    {
        steppysnd = ground_boundtitrle_cardd
...
function scr_pizzaface_p2_fall() //scr_pizzaface_p2_fall
{
    image_speed = 0.35
    hsp = 0
    with (obj_player1)
    ...
    switch substate
    {
        ...
        case (135 << 0):
            ...
            if (grounded && vsp > 0)
            {
                ...
                layer_background_change(bg, 2507)
        ...
        case (8 << 0):
            ...
            {
                laugh_snd = ground_boundtitrle_cardd
...
function scr_pizzaface_p2_normal() //scr_pizzaface_p2_normal
{
    if (elitehit <= 0)
    {
        destroyable = 1
...
function scr_pizzaface_p2_look() //scr_pizzaface_p2_look
{
    hsp = 0
    if (fishingbuffer > 0)
        fishingbuffer--
...
function scr_pizzaface_p2_fishing() //scr_pizzaface_p2_fishing
{
    hsp = 0
...
function boss_pizzahead_pinup() //boss_pizzahead_pinup
{
    hsp = 0
    if (floor(image_index) == (image_number - 1))
    {
...
function boss_pizzahead_throwing() //boss_pizzahead_throwing
{
    hsp = 0
    if (!brick)
    {
...
function boss_pizzahead_shotgun() //boss_pizzahead_shotgun
{
    switch substate
    {
        case (268 << 0):
...
function boss_pizzahead_p2_phase1hurt() //boss_pizzahead_p2_phase1hurt
{
